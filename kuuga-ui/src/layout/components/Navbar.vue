    ...
    <div class="right-menu">
      <template v-if="device!=='mobile'">
        ...
        <el-tooltip content="源码地址" effect="dark" placement="bottom">
          <kuu-ga-git id="kuuga-git" class="right-menu-item hover-effect" />
        </el-tooltip>

        <el-tooltip content="文档地址" effect="dark" placement="bottom">
          <kuu-ga-doc id="kuuga-doc" class="right-menu-item hover-effect" />
        </el-tooltip>
...
import kuugaGit from '@/components/kuuga/Git'
import kuugaDoc from '@/components/kuuga/Doc'
